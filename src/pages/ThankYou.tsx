        ...
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                <Link
                  to={`/resources?utm_source=thank_you${location.search ? "&" + location.search.substring(1) : ""}`}
                >
                  Explore Free Ebooks
                </Link>
              </Button>
              <Button
                asChild
                variant="outline"
                className="border-blue-600 text-blue-400 hover:bg-blue-600 hover:text-white px-6 py-4"
              >
