...
const BrandStageQuiz: React.FC = () => {
  const [currentStep, setCurrentStep] = useState<'intro' | 'quiz' | 'email' | 'results'>('intro');
  ...
  const questions: QuizQuestion[] = [
    {
      ...
      options: [
        { text: "Nonexistent - we're still figuring it out", score: 1, tip: "No mission? Don't worry, our Foundation Guide helps!" },
  ...
  const calculateResult = (): QuizResult => {
    ...
    if (totalScore <= 12) {
      return {
        ...
        description: "No worries—every unicorn started here. You need a solid foundation to build on.",
        score: totalScore,
        maxScore,
        recommendations: [
      ...
      return {
        ...
        description: "Impressive! You're ahead of 90% of startups. Time to scale with confidence.",
        score: totalScore,
        maxScore,
        recommendations: [
    ...
    return (
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <Card className="bg-dark-800/50 border-dark-700">
          <CardHeader>
            <Badge variant="outline" className="w-fit text-secondary-400 border-secondary-500/30">
              {question.category}
            </Badge>
              ...
              >
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    ...
                    {option.tip && (
                      <div className="text-xs text-secondary-400">{option.tip}</div>
                    )}
                  </div>
                </div>
              </button>
    ...
    return (
      <div className="max-w-lg mx-auto text-center space-y-8">
            ...
            <form onSubmit={handleEmailSubmit} className="space-y-4">
              ...
              <div className="flex items-start space-x-2">
                ...
                <Label htmlFor="consent" className="text-sm text-gray-300 leading-relaxed">
                  Send me free branding insights and tips (no spam, unsubscribe anytime)
                </Label>
              </div>
        ...
        <p className="text-xs text-gray-400">
          Don't worry—we hate spam too. Just actionable branding insights from founders who've been there.
        </p>
      </div>
    );
  }
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-6">
          ...
          <div className="flex justify-center items-center space-x-8">
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-secondary-400">{Math.round((result.score / result.maxScore) * 100)}%</div>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {result.recommendations.map((rec, index) => (
                <div key={index} className="flex items-start space-x-3 p-4 bg-dark-700/50 rounded-lg">
