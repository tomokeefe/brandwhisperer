...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-dark-950">
      ...
      <div className="w-full relative z-10 pt-16 lg:pt-20 pb-8 lg:pb-12 px-6">
        <div className="w-full flex justify-center items-center">
          ...
          <div className="w-full max-w-6xl">
            <div className="text-center px-4">
              ...
              {/* Main Headline */}
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight mb-6 lg:mb-8 text-white">
              ...
              {/* Value Proposition */}
              <p className="text-base lg:text-lg text-gray-400 mb-8 lg:mb-12 leading-relaxed max-w-4xl mx-auto">
