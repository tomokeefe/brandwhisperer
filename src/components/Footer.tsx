    ...
    >
      ...
      <div className="relative">
        <div className="container-custom py-20 lg:py-24 px-6 lg:px-8">
          ...
          <div
            className={cn(
              "mt-20 pt-12 border-t border-dark-200 px-4 transition-all duration-1000",
              isFooterVisible
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-8",
            )}
          ...
          >
            <div className="text-center mb-8">
              <h3 className="text-xl font-semibold text-dark-900 mb-2 flex items-center justify-center space-x-2">
              ...
              <p className="text-dark-600 text-sm">
                Updated metrics from our active projects and success stories
              </p>
            </div>
              ...
              {liveMetrics.map((metric, index) => {
                ...
                return (
                  <div
                    key={index}
                    className={cn(
                      "text-center p-4 rounded-lg bg-dark-50 hover:bg-dark-100 transition-all duration-300 hover:scale-105 hover:shadow-md",
                  ...
                  >
                    ...
                    <div className="text-3xl font-bold text-primary-600 mb-1 transition-all duration-1000">
                      {metric.value}
                    </div>
                    <div className="text-sm text-dark-600 mb-1">
                      {metric.label}
                    </div>
                    <div className="text-xs text-green-600 font-medium flex items-center justify-center space-x-1">
